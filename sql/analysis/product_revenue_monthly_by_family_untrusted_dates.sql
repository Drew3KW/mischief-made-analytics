...
-- Purpose:
-- Monthly product family revenue trends for business-facing product analysis.
...
-- Notes:
-- - Uses marts only
-- - Reuses the same product family logic as anl_product_performance_by_family
...
CREATE OR REPLACE VIEW `mischief-made-analytics.marts.anl_product_revenue_monthly_by_family_untrusted_dates` AS

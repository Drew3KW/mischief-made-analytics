-- File: sql/staging/create_stg_shopify_customers_hybrid_dry_run.sql
-- Model: raw_load.stg_shopify_customers_hybrid_dry_run
-- Purpose:
-- Simulate staging.stg_shopify_customers using the Shopify hybrid raw customer
-- candidate instead of production raw.shopify_customers.
--
-- Important notes:
...
CREATE OR REPLACE TABLE `mischief-made-analytics.raw_load.stg_shopify_customers_hybrid_dry_run` AS

-- File: sql/staging/create_stg_shopify_products_api_shadow.sql
-- Model: raw_load.stg_shopify_products_api_shadow
-- Purpose:
-- Apply the current products staging contract to the Shopify API raw candidate.
--
-- Important notes:
...
CREATE OR REPLACE TABLE `mischief-made-analytics.raw_load.stg_shopify_products_api_shadow` AS

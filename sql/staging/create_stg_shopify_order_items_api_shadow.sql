-- File: sql/staging/create_stg_shopify_order_items_api_shadow.sql
-- Model: raw_load.stg_shopify_order_items_api_shadow
-- Purpose:
-- Apply the current order-item staging contract to the Shopify API raw candidate.
--
-- Important notes:
...
CREATE OR REPLACE TABLE `mischief-made-analytics.raw_load.stg_shopify_order_items_api_shadow` AS
